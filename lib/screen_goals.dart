...
class _RetirementResultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final highlighted = data.entries
        .where((e) => _isHighlightKey(e.key))
        .toList();
...
class _ResultRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: isLast
        ...
        : BoxDecoration(
            border: Border(
              bottom: BorderSide(color: AppColors.green.withOpacity(0.07)),
            ),
          ),
    child: Row(
      children: [
          ...
          children: [
            ...
            if (_showAdvanced) ...[
              ...
              _SheetField(
                ...
                validator: (v) {
                  final n = double.tryParse(v ?? '');
                  return (n == null || n <= 0 || n > 20) ? '0.1–20' : null;
                },
              ),
              const SizedBox(height: 12),
              _SheetField(
        ...
        child: Column(
          ...
          children: [
            ...
            _SheetField(
              ...
              validator: (v) {
                final n = double.tryParse(v ?? '');
                return (n == null || n <= 0 || n > 50) ? '1–50 years' : null;
              },
            ),
            const SizedBox(height: 20),
...
class _SheetSectionDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
    children: [
      Container(width: 12, height: 1, color: AppColors.green.withOpacity(0.3)),
      const SizedBox(width: 8),
      Text(
        label,
        style: TextStyle(
      ...
      const SizedBox(width: 8),
      Expanded(
        child: Container(height: 1, color: AppColors.green.withOpacity(0.08)),
      ),
    ],
  );
}
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            ...
            borderSide: BorderSide(color: AppColors.green.withOpacity(0.15)),
          ),
